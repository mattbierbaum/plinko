...
opt:option('-d', 'Collision damping constant', '0.6', tonumber):argname('damp')
P.cli.options_particles(opt, {-0.05, -1.4}, {0,0}, {0.05, 0.45}, nil, 'uniform2d')
...
local conf = {
    ...
    particles = {P.cli.args_to_particles(arg, {w/2+0.0010330110, h-0.5})},
    objects = obj,
    observers = {
        P.cli.args_to_observer(arg, box),
        P.observers.TimePrinter(1e2),
